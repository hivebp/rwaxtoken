...
namespace eosio {
   static constexpr name TOKEN_BASE_CONTRACT = name("waxtokenbase");
    ...
    * @{
    */
   class [[eosio::contract("eosio.token")]] rwaxtoken : public contract {
      public:
         ...
         using create_action = eosio::action_wrapper<"create"_n, &rwaxtoken::create>;
         using issue_action = eosio::action_wrapper<"issue"_n, &rwaxtoken::issue>;
         using retire_action = eosio::action_wrapper<"retire"_n, &rwaxtoken::retire>;
         using transfer_action = eosio::action_wrapper<"transfer"_n, &rwaxtoken::transfer>;
         using open_action = eosio::action_wrapper<"open"_n, &rwaxtoken::open>;
         using close_action = eosio::action_wrapper<"close"_n, &rwaxtoken::close>;
      private:
